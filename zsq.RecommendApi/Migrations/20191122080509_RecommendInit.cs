...
{
    public partial class RecommendInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectIntroduction = table.Column<string>(nullable: true),
                    ProjectTags = table.Column<string>(nullable: true),
                    ProjectFinStage = table.Column<string>(nullable: true),
